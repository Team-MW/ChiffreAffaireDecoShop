...
<template>
  ...
  <CalendarRoot
    ...
    data-slot="calendar"
    :class="cn('p-2 [--cell-radius:var(--radius-md)] [--cell-size:1.75rem] group/calendar bg-background in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent', props.class)"
  >
